use actix_web::{http::StatusCode, web::HttpResponse, FromRequest, ResponseError};
use serde::Serialize;
...
pub fn configure<T: BlockDevicesApi + ChildrenApi + JsonGrpcApi + NexusesApi + NodesApi + PoolsApi + ReplicasApi + SpecsApi + VolumesApi + WatchesApi + 'static, A: FromRequest + 'static>(cfg: &mut actix_web::web::ServiceConfig) {
